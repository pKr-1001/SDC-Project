            ...
            <div className="w-full flex flex-col">
                <div className='grid gap-4 items-center h-12 md:h-20 grid-col-3'>
                    <div className='flex flex-nowrap h-full items-center gap-6 sm:gap-7'>
                        <div role="menu">
                            <span className="mr-7 border-black border-b border-opacity-0 hover:border-opacity-100 transition color duration-300 active:border-opacity-100 whitespace-nowrap">
                                <span aria-hidden="false" className="font-sans tracking-widest uppercase text-black text-xs hover:cursor-pointer font-noraml">
                                    SHOP
                                </span>
                            </span>
                                <a className="no-underline border-black w-fit cursor-pointer border-b border-opacity-0 hover:border-opacity-100 transition-color duration-300 active:border-opacity-100 mr-7 whitespace-nowrap">
                                    <span aria-hidden="false" className="font-sans tracking-widest uppercase text-black text-xs hover:cursor-pointer font-noraml">
                                        BEST SELLERS
                                    </span>
                                </a>
                ...
                <div className='flex shrink-0 justify-end items-center w-full'>
                    <div className='flex justify-around gap-6 sm:gap-7 items-center'>
                        ...
                        <span>
                            ...
                            <path d="M0.945068 7.56598L2.27867 15.9725H13.7235L15.0571 7.56598H0.945068Z" stroke="black" stroke-width="1.6" stroke-linejoin="round"></path>
                            </g>
                            </svg>
                            </div>
                            </a>
