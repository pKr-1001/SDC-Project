...
const HeaderSmallContent = () => {
    ...
    return (
        <>
        <nav className="nav-bar flex w-full px-5 md:px-15 overflow-y-auto bg-cream h-full">
            <div className="w-full flex flex-col h-full">
                <div className='grid gap-4 items-center h-12 md:h-20 grid-col-3 h-full'>
                    ...
                    <div className='w-20 flex justify-center items-center mx-auto margin'>
                        <div aria-hidden="true" className='hover:opacity-70'>
                            <a className="cursor-pointer">
                            <svg className='w-4 h-8 md:h-10 lg-w-6 lg-h-full z-40 max-auto lg-mr-auto' viewBox='0 0 23 57'>
...
export default HeaderSmallContent