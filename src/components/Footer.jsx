    ...
    <>
      <footer className="bg-dark text-white py-3">
        <div className="pt-5 pt-md-2 pt-xl-4 px-3 px-md-5 px-xl-7 m-0 pb-2 pb-md-0">
            <h2 className="font-sans text-uppercase fs-6 fs-md-4 fs-xl-3 text-white pb-2 pb-md-3 pb-xl-4">RED BOTTLE COFFEE</h2>
            <div className="d-flex flex-column flex-md-row justify-content-md-between">
                <ul className="list-unstyled d-flex flex-row flex-wrap ms-1 pe-4">
                    <li className="pb-2 pb-sm-3 w-50 w-md-auto ps-1 ps-md-0 pe-3 pe-md-5 pe-lg-10 w-xl-25">
                        <div className="bg-black">
                            <h3 className="font-sans tracking-widest uppercase text-white text-sm xl:text-md pb-3">COMPANY</h3>
                            <ul className="text-white">
                                <li className="py-2.5 xl:py-1.5">
                    ...
                    <li className="pb-8 w-1/2 sm:truncate md:w-auto pl-1 md:pr-10 lg:pr-20 xl:w-1/4">
                        <div className="bg-black">
                            <h3 className="font-sans tracking-widest uppercase text-white text-sm xl:text-md pb-3">LEARN</h3>
                            <ul className="text-white">
                                <li className="py-2.5 xl:py-1.5">
                    ...
                    <li className="pb-8 w-1/2 sm:truncate md:w-auto pl-1 md:pr-10 lg:pr-20 xl:w-1/4">
                        <div className="bg-black">
                            <h3 className="font-sans tracking-widest uppercase text-white text-sm xl:text-md pb-3">MORE</h3>
                            <ul className="text-white">
                                <li className="py-2.5 xl:py-1.5">
                                ...
                                <li className="py-2.5 xl:py-1.5">
                                    <a href="/us/eng/subscriptions/gift-subscriptions" target="_self" rel="" className="no-underline border-white w-fit cursor-pointer border-b border-opacity-0 hover:border-opacity-100 transition-color duration-300 active:border-opacity-100">
                                        <span aria-hidden="false" className="font-sans tracking-widest uppercase text-white text-xs font-normal">Gift Subscriptions</span>
                                    </a>
                                </li>
                            </ul>
                        </div>
                ...
                <div className="md:justify-self-end md:w-5/12 -mt-1">
                    <form className="border-b max-w-max border-white bg-black pt-7 md:pt-0 pb-0.5">
                        <label htmlFor="newsletterEmailInput">
                            <span aria-hidden="false" className="font-sans tracking-widest uppercase text-white text-sm xl:text-md font-normal">Subscribe and Stay Updated</span>
                        </label>
                        ...
                        <div className="flex flex-row">
                            <input id="newsletterEmailInput" className="border-0 border-white py-2 px-0 w-full text-white bg-black placeholder-white font-serif text-xs" type="email" autoComplete="email" inputMode="email" placeholder="enter your email address" value="" onChange={handleChange}/>
                                <button className="py-2" type="submit" aria-label="sign up">
                                    <div className="hover:opacity-70">
                                        <svg className="fill-current text-white undefined" width="44" height="8" viewBox="0 0 44 8" fill="none" xmlns="http://www.w3.org/2000/svg" style={{ transform: 'rotate(0deg)', ...myStyle }}>
                            ...
                            <a href="https://www.twitter.com/bluebottleroast" rel="noreferrer" target="_blank">
                                <div className="hover:opacity-70">
                                    <svg aria-labelledby="bbTwitter" fill="none" height="14" id="twitter-icon" viewBox="0 0 18 14" width="18" xmlns="http://www.w3.org/2000/svg">
                                        <title id="bbTwitter">Go to Red Bottle Twitter</title>
                            ...
                            <a href="https://www.instagram.com/bluebottle" rel="noreferrer" target="_blank">
                                <div className="hover:opacity-70">
                                    <svg aria-labelledby="bbInstagram" fill="none" height="17" id="instagram-icon" viewBox="0 0 17 17" width="17" xmlns="http://www.w3.org/2000/svg">
                                        <title id="bbInstagram">Go to Red Bottle Instagram</title>
                            ...
                            <a href="https://www.youtube.com/channel/UCyki4e6RG84BT_xzi4oYkRw" rel="noreferrer" target="_blank">
                                <div className="hover:opacity-70">
                                    <svg aria-labelledby="bbYoutube" fill="none" height="16" id="youtube-icon" viewBox="0 0 22 16" width="22" xmlns="http://www.w3.org/2000/svg">
                                        <title id="bbYoutube">Go to Red Bottle Youtube</title>
            ...
            <hr className="border-white border-t -mx-5 md:-mx-10 xl:-mx-15"/>
                <div className="flex flex-col gap-y-6 lg:flex-row items-center lg:place-content-between pt-6 md:pt-3 lg:pt-8 xl:pt-11">
                    ...
                    <span aria-hidden="false" className="font-sans tracking-widest uppercase text-white text-xs flex text-center font-normal">© 2024 RED BOTTLE COFFEE Inc., All Rights Reserved</span>
                </div>
        </div>
    </footer>
    </>
